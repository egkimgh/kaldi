...
DftComputer::DftComputer(const SpectrogramOptions &opts)
...
DftComputer::DftComputer(const DftComputer &other):
...
DftComputer::~DftComputer() {
  delete srfft_;
}

void DftComputer::Compute(BaseFloat signal_log_energy,
                                  BaseFloat vtln_warp,
