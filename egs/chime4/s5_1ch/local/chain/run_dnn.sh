...
if [ $stage -le 13 ]; then
  ...
  local/chime4_calc_wers.sh exp/tri4a_dnn_tr05_multi_$enhan $enhan exp/tri3b_tr05_multi_${enhan}/graph_tgpr_5k > exp/tri4a_dnn_tr05_multi_$enhan/best_wer_$enhan.result
  ...
  ./local/chime4_calc_wers_smbr.sh exp/tri4a_dnn_tr05_multi_${enhan}_smbr_i1lats ${enhan} exp/tri4a_dnn_tr05_multi_${enhan}/graph_tgpr_5k \
