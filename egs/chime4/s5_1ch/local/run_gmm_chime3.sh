...
if [ $stage -le 9 ]; then
  ...
  local/chime4_calc_wers.sh exp/tri3b_tr05_multi_$enhan $enhan exp/tri3b_tr05_multi_${enhan}/graph_tgpr_5k > exp/tri3b_tr05_multi_$enhan/best_wer_$enhan.result
