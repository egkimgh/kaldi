...
# make feature for training multi = simu + real
datadir=data
mkdir -p $datadir
featdir=$feat/$enhan
if [ $stage -le 1 ]; then
...
# multi = simu + real
if [ $stage -le 3 ]; then
  utils/combine_data.sh $datadir/tr05_multi_$enhan $datadir/tr05_simu_$enhan $datadir/tr05_real_$enhan
  utils/combine_data.sh $datadir/dt05_multi_$enhan $datadir/dt05_simu_$enhan $datadir/dt05_real_$enhan
  utils/combine_data.sh $datadir/et05_multi_$enhan $datadir/et05_simu_$enhan $datadir/et05_real_$enhan
fi
...
# train dnn
dir=exp/tri4a_dnn_si_tr05_multi_$enhan
...
if [ $stage -le 6 ]; then
  ...
  steps/nnet/decode.sh --nj 4 --num-threads 3 --cmd "$decode_cmd" --acwt 0.10 --config conf/decode_dnn.config \
    $dir/graph_tgpr_5k $datadir/dt05_real_$enhan $dir/decode_tgpr_5k_dt05_real_$enhan &
  steps/nnet/decode.sh --nj 4 --num-threads 3 --cmd "$decode_cmd" --acwt 0.10 --config conf/decode_dnn.config \
    $dir/graph_tgpr_5k $datadir/dt05_simu_$enhan $dir/decode_tgpr_5k_dt05_simu_$enhan &
  steps/nnet/decode.sh --nj 4 --num-threads 3 --cmd "$decode_cmd" --acwt 0.10 --config conf/decode_dnn.config \
    $dir/graph_tgpr_5k $datadir/et05_real_$enhan $dir/decode_tgpr_5k_et05_real_$enhan &
  steps/nnet/decode.sh --nj 4 --num-threads 3 --cmd "$decode_cmd" --acwt 0.10 --config conf/decode_dnn.config \
    $dir/graph_tgpr_5k $datadir/et05_simu_$enhan $dir/decode_tgpr_5k_et05_simu_$enhan &
  wait;
fi
...
dir=exp/tri4a_dnn_si_tr05_multi_${enhan}_smbr
srcdir=exp/tri4a_dnn_si_tr05_multi_${enhan}
acwt=0.1
...
if [ $stage -le 7 ]; then
  steps/nnet/align.sh --nj $nj --cmd "$train_cmd" \
    $datadir/tr05_multi_${enhan} data/lang $srcdir ${srcdir}_ali
  steps/nnet/make_denlats.sh --nj $nj --cmd "$decode_cmd" --config conf/decode_dnn.config --acwt $acwt \
    $datadir/tr05_multi_${enhan} data/lang $srcdir ${srcdir}_denlats
fi
...
if [ $stage -le 9 ]; then
  for ITER in 1; do
    steps/nnet/decode.sh --nj 4 --num-threads 3 --cmd "$decode_cmd" --config conf/decode_dnn.config \
      ...
      exp/tri4a_dnn_si_tr05_multi_${enhan}/graph_tgpr_5k $datadir/dt05_real_${enhan} $dir/decode_tgpr_5k_dt05_real_${enhan}_it${ITER} &
    steps/nnet/decode.sh --nj 4 --num-threads 3 --cmd "$decode_cmd" --config conf/decode_dnn.config \
      --nnet $dir/${ITER}.nnet --acwt $acwt \
      exp/tri4a_dnn_si_tr05_multi_${enhan}/graph_tgpr_5k $datadir/dt05_simu_${enhan} $dir/decode_tgpr_5k_dt05_simu_${enhan}_it${ITER} &
    steps/nnet/decode.sh --nj 4 --num-threads 3 --cmd "$decode_cmd" --config conf/decode_dnn.config \
      --nnet $dir/${ITER}.nnet --acwt $acwt \
      exp/tri4a_dnn_si_tr05_multi_${enhan}/graph_tgpr_5k $datadir/et05_real_${enhan} $dir/decode_tgpr_5k_et05_real_${enhan}_it${ITER} &
    steps/nnet/decode.sh --nj 4 --num-threads 3 --cmd "$decode_cmd" --config conf/decode_dnn.config \
      --nnet $dir/${ITER}.nnet --acwt $acwt \
      exp/tri4a_dnn_si_tr05_multi_${enhan}/graph_tgpr_5k $datadir/et05_simu_${enhan} $dir/decode_tgpr_5k_et05_simu_${enhan}_it${ITER} &
  done
fi

# Re-generate lattices, run 4 more sMBR iterations
dir=exp/tri4a_dnn_si_tr05_multi_${enhan}_smbr_i1lats
srcdir=exp/tri4a_dnn_si_tr05_multi_${enhan}_smbr
acwt=0.1
...
if [ $stage -le 13 ]; then
  ...
  local/chime4_calc_wers.sh exp/tri4a_dnn_si_tr05_multi_$enhan $enhan exp/tri3b_tr05_multi_${enhan}/graph_tgpr_5k > exp/tri4a_dnn_si_tr05_multi_$enhan/best_wer_$enhan.result
  head -n 15 exp/tri4a_dnn_si_tr05_multi_$enhan/best_wer_$enhan.result
  # decoded results of enhanced speech using sequence-training DNN
  ./local/chime4_calc_wers_smbr.sh exp/tri4a_dnn_si_tr05_multi_${enhan}_smbr_i1lats ${enhan} exp/tri4a_dnn_si_tr05_multi_${enhan}/graph_tgpr_5k \
    > exp/tri4a_dnn_si_tr05_multi_${enhan}_smbr_i1lats/best_wer_${enhan}.result
  head -n 15 exp/tri4a_dnn_si_tr05_multi_${enhan}_smbr_i1lats/best_wer_${enhan}.result
fi
